...
void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(LAN_RST_GPIO_Port, &GPIO_InitStruct);
  ...
  /**/
  LL_GPIO_SetPinPull(LAN_IRQ_GPIO_Port, LAN_IRQ_Pin, LL_GPIO_PULL_DOWN);

  /**/
  LL_GPIO_SetPinPull(LAN_SYNC0_GPIO_Port, LAN_SYNC0_Pin, LL_GPIO_PULL_DOWN);

  /**/
  LL_GPIO_SetPinPull(LAN_SYNC1_GPIO_Port, LAN_SYNC1_Pin, LL_GPIO_PULL_DOWN);

  /**/
  LL_GPIO_SetPinMode(LAN_IRQ_GPIO_Port, LAN_IRQ_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(LAN_SYNC0_GPIO_Port, LAN_SYNC0_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(LAN_SYNC1_GPIO_Port, LAN_SYNC1_Pin, LL_GPIO_MODE_INPUT);

  /* EXTI interrupt init*/
  NVIC_SetPriority(EXTI0_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),3, 0));
  NVIC_EnableIRQ(EXTI0_IRQn);
  NVIC_SetPriority(EXTI1_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),4, 0));
