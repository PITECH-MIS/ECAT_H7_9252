...
void pdi_isr(void);    // put it in ESC_PDI_IRQn Handler
void pdi_isr_background(void);  // put it in while loop, no need when mixed polling/interrupt mode
void sync0_isr(void);  // put it in ESC_SYNC0_IRQn Handler
