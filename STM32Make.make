...
User/Delay/delay.c \
User/EtherCAT_Config/slave_objectlist.c \
User/SOES/ecat_slv.c \
User/SOES/esc.c \
User/SOES/esc_coe.c \
User/SOES/esc_eep.c \
User/SOES/esc_eoe.c \
User/SOES/esc_foe.c \
User/SOES/hal/stm32-lan9252/bsp_isr.c \
User/SOES/hal/stm32-lan9252/esc_hw.c \
User/UART/kfifo.c \
User/UART/printf.c \
User/UART/utils.c
...
CPP_SOURCES = \
User/Apps/app.cpp \
User/UART/parser.cpp \
User/WS2812/ws2812.cpp \
build/main.cpp
...
-IUser/Apps \
-IUser/Delay \
-IUser/EtherCAT_Config \
-IUser/SOES \
-IUser/SOES/hal/stm32-lan9252 \
-IUser/SOES/include/sys/gcc \
-IUser/Shell \
-IUser/UART \
-IUser/WS2812 \
-IUser/iFOC-Port
...
CXXFLAGS += -Wno-error=register -Wno-register -fno-exceptions -fno-rtti 
...
#######################################
# link script
LDSCRIPT = STM32H750VBTx_FLASH_Modified.ld
